...
公開環境で高品質画像を使う場合は、VercelのEnvironment Variablesに `IMAGE_API_PROVIDER=pollinations` と `POLLINATIONS_PROXY_SECRET` を入れます。PollinationsのSecret Keyを取得したら `POLLINATIONS_API_KEY` も追加してください。
